    ...
    for record in event['records']:
        ...
        try:
            ...
            transformed_data = {
                ...
                'brand_name': new_image['brand_name']['S'],
            ...
            # If there is any error with processing the record, mark it as ProcessingFailed and return the recordId
            output_records.append({
                'recordId': record['recordId'],
                'result': 'TranformationsFailed',
                'data': record['data']  # simply return the original data back
            })
